...
#wine
Data = np.genfromtxt('https://archive.ics.uci.edu/ml/machine-learning-databases/wine/wine.data', dtype = float, delimiter = ",")
np.save("wine.npy", Data)

#bezdekIris
Data = np.genfromtxt('https://archive.ics.uci.edu/ml/machine-learning-databases/iris/bezdekIris.data', delimiter = ",",  dtype = None, usecols=(0,1,2,3))
np.save("bezdekIris.npy", Data)